...
* [x] 3개 LLM 모델 다운로드
* [x] API 호출 테스트
* [x] Continue Extension 설치 (v2.0.0)
* [x] Cline Extension 설치 (v3.89.2)
* [x] Continue Ollama 설정

---

## 진행 중 항목

* [x] 01_Local_ChatGPT 완료
* [ ] 02_IDE_Agent - Continue 설치 및 설정 완료
  - [x] Continue Extension 설치 (v2.0.0)
  - [x] Ollama 연동 설정
  - [x] API 테스트
  - [x] Cline Extension 설치 (v3.89.2)
  - [ ] Cline Ollama 연동 테스트
  - [ ] Continue vs Cline 비교 실습
